...
class MMfromServer(_context: Context, _listener: MMfromServerListener) : AsyncTask<Void, Void, String>() {
    ...
    companion object {
        ...
        const val REQUEST_COURSE_LIST = 2
        const val REQUEST_COURSE_INFO = 3
        const val REQUEST_COURSE_CAROUSEL_VIEW_LIST = 4
        const val REQUEST_USER_COURSE_LIST = 21
        const val REQUEST_USER_COURSE_PURCHASED = 22
        const val CREATE_TICKET = 100
    }
...
//        println(sessionId)
        ...
        when (request) {
            ...
            REQUEST_COURSE_CAROUSEL_VIEW_LIST -> {
                args.add("request" to "COURSE_CAROUSEL_VIEW_LIST")
            }
...
//            println(resp)
    ...
    private fun getUrl(): String {
        return when {
            request <= REQUEST_COURSE_CAROUSEL_VIEW_LIST -> baseUrl + "get.php"
